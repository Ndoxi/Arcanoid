...
namespace App.StateMachines
{
    public class AppStateMachine : StateMachine
    {
        ...
        [Inject] public LoadingState LoadingState { get; private set; }
        [Inject] public GameplayState GameplayState { get; private set; }
        [Inject] public PauseState PauseState { get; private set; }
        [Inject] public UnloadingState UnloadingState { get; private set; }
        ...
        public void Init()
        {
            _states = new Dictionary<Type, IState>()
            {
                ...
                { typeof(UnloadingState), UnloadingState }
            };
        }
    }
}